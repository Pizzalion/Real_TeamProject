     ...
     <div class="w3-row-padding w3-grayscale">
	  <c:forEach var="vo" items="${rList }">
	    ...
	    <a href="main_detail.jsp?mode=1&com_no=${vo.com_no }">
	      ...
	      <p>${vo.com_rank }</p>
	      <p ><a href="main_detail.jsp?mode=301&com_no=${vo.com_no }"><button class="w3-button w3-light-grey w3-block" >상세보기</button></a></p>
	    </div>
	   </c:forEach>
    	<div style="height:15px" align="center"></div>
            <div style="margin-top: 430px;margin-left:730px;color:black;font-size: 12px">
